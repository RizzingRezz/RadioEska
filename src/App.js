  ...
  return (
    <div className="App">
      <Router>
        ...
        <Routes>
          <Route path='/' exact element={<Dom link={link} city={city}/>} />
          <Route path='/goraca20' exact element={<Goraca20 city={city}/>} />
          <Route path='/rap20' exact element={<Rap20 city={city}/>} />
          <Route path='/eskaImpreska' exact element={<Impreska city={city}/>} />
        </Routes>
      </Router>
    </div>
  );

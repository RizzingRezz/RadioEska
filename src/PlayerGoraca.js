...
function PlayerGoraca({name,artist,image}) {
    ...
    return (
        <div className='player'>
            <Box component="img" sx={{height:"180px", width:"180px",borderRadius: "15px" }}  alt="Eska GORĄCA 20" src={image}/>
            <br/>
            {isPlayed ?
            ...
            <ReactPlayer
                    playing={playing}
                    url="https://radio.stream.smcdn.pl/icradio-p/6130-1.aac/playlist.m3u8"
                    controls
                    playsinline
                    preload="metadata"
                    style={{ display: "none" }}
